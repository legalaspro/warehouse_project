...
def main():
    ...
    params = [
        ...
        Parameter(name='base_footprint_frame', value='robot_base_footprint'), #TODO try "robot_base_link"
        ...
        Parameter(name='waypoints.loading_position', value=[4.4, -0.35, math.radians(-90)]),
        Parameter(name='waypoints.preshipping_position', value=[2.0, 0.0, math.radians(180)]),
        Parameter(name='waypoints.shipping_position', value=[2.0, 1.2, math.radians(90)]),
        ...
        Parameter(name='stop_dist', value=0.15),
